...
public class placesList extends Fragment  {
    ...
    public static placesList newInstance(String param1, String param2) {
        placesList fragment = new placesList();
